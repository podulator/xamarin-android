...
fix-linux-post-build:
	...
	(rm -rf tmp-DotNetZip; mkdir tmp-DotNetZip; cd tmp-DotNetZip && (wget -O DotNetZip.zip https://www.nuget.org/api/v2/package/DotNetZip/1.9.8 ; unzip DotNetZip.zip ; cp lib/net20/Ionic.Zip.dll ../bin/$(CONFIGURATION)/lib/mandroid/ ; cp lib/net20/Ionic.Zip.dll ../bin/$(CONFIGURATION)/lib/xbuild/Xamarin/Android/Ionic.Zip.dll ))
